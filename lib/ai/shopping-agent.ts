...
| minPrice | number | Minimum price in PKR (0 = no minimum) |
| maxPrice | number | Maximum price in PKR (0 = no maximum) |
...
**For "leather sofas under Pkr1000":**
\`\`\`json
{
  "query": "",
  "category": "sofas",
...
- name, price, priceFormatted (e.g., "Pkr599.00")
...
**[Product Name](/products/slug)** - Pkr599.00
- Material: Oak wood
...
- Always include prices in PKR (Pkr)
